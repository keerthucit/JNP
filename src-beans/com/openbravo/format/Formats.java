...
public abstract class Formats {
    ...
    public final static Formats DATETIME = new FormatsDateTime();
    ...
    private static DateFormat m_datetime = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    ...
    private static final class FormatsDateTime extends Formats {
        protected String formatValueInt(Object value) {
            return m_datetime.format((Date) value);
        }
        protected Object parseValueInt(String value) throws ParseException {
            try {
                return m_datetime.parse(value);
            } catch (ParseException e) {
                // segunda oportunidad como fecha normalita
                return m_dateformat.parse(value);
            }
