...
public class PreparedSentence extends JDBCSentence {
    ...
    private static final class PreparedSentencePars implements DataWrite {
        ...
        public void setTimestamp(int paramIndex, java.util.Date dValue) throws BasicException {        
		 ...
		 public void setDate(int paramIndex, java.util.Date dtValue) throws BasicException {        
            try {
                m_ps.setObject(paramIndex, dtValue == null ? null : new Date(dtValue.getTime()), Types.DATE);
            } catch (SQLException eSQL) {
                throw new BasicException(eSQL);
            }
        }   
...
//        }
        ...
        public void setImage(int paramIndex, BufferedImage iValue) throws BasicException {
