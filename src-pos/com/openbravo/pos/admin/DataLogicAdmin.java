...
public class DataLogicAdmin extends BeanFactoryDataSingle {
    ...
    public void init(Session s){
        ...
        m_tpeople = new TableDefinition(s,
            "PEOPLE"
            , new String[] {"ID", "NAME", "USERNAME", "APPPASSWORD", "ROLE", "VISIBLE"}
            , new String[] {"ID", AppLocal.getIntString("label.peoplename"),AppLocal.getIntString("label.userName"), AppLocal.getIntString("Label.Password"), AppLocal.getIntString("label.role"), AppLocal.getIntString("label.peoplevisible")}
