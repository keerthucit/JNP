...
public class TicketInfo implements SerializableRead, Externalizable {
  ...
  private int refundId;
    ...
    private java.util.Date m_dTicketDate;
    private int seats;
...
//        showName = (String) in.readObject();
    ...
    public void readValues(DataRead dr) throws BasicException {
        ...
        showName = dr.getString(10);
        advanceDate = dr.getString(11);
    ...
    public void setDate(java.util.Date dDate) {
     ...
     public java.util.Date getTicketDate() {
        ...
        return m_dTicketDate;
    }

    public void setTicketDateDate(java.util.Date dDate) {
        m_dTicketDate = dDate;
    }
   ...
   public UserInfo getUser() {
    ...
    public void setActiveShow(String value) {
       m_sActiveShow = value;
    }

    public String getActiveShow() {
       return m_sActiveShow;
  }
    ...
    public double getArticlesCount() {
        ...
        TicketLineInfo oLine = new TicketLineInfo();
        ...
        oLine.setCount(dArticles);

        return dArticles;
    }

     public double getDisArticlesCount() {
        ...
        for (Iterator<TicketLineInfo> i = m_aLines.iterator(); i.hasNext();) {
            ...
            oLine = i.next();
            if(oLine.getTicketDiscount().equals("Y")){
            dArticles += oLine.getMultiply();}
    ...
    public double getSubTotal() {
      ...
      public double getDiscountTotal() {
        double sum = 0.0;
        for (TicketLineInfo line : m_aLines) {
            sum += (line.getActualValue() - line.getDiscountValue());
        }
        return sum;
    }
      ...
      public double getDiscountValue() {
          ...
          if(line.getTicketGroup().equals("N") && line.getTicketDiscount().equals("Y")){
               if(getTicketType() == TicketInfo.RECEIPT_REFUND){
                    if((-1)*getDisArticlesCount()>=line.getDiscountQty()){
                     distPrice = ( line.getDiscountPrice() * (-1)*getDisArticlesCount());
                    }
               }else{
                    if(getDisArticlesCount()>=line.getDiscountQty()){
                    distPrice = ( line.getDiscountPrice() * getDisArticlesCount());
               }
               }
    ...
    public double getTotal() {
        double total =0.0;
          if(getTicketType() == TicketInfo.RECEIPT_REFUND){
              total = getSubTotal() + getTax()+ getDiscountValue();
          }else{
              total = getSubTotal() + getTax()-getDiscountValue();
          }
        return total;
     ...
     public void setCancelFee(double cancellationFee){
    ...
    public String printSysDate() {
        ...
        String sysDate = sdf.format(m_dDate).toString();
        return sysDate;
    }
     public String printShowDate() {
       ...
       Date showDt = null;
        ...
        showDate = df.format(showDt);
        return showDate;
    }

    public String printTime() {
        SimpleDateFormat sdf=new SimpleDateFormat("HH:mm");
        String sysDate = sdf.format(new Date()).toString();
        return sysDate;
    }
    ...
    public String printTotal() {
     ...
     public String printDiscountTotal() {
        ...
        return Formats.CURRENCY.formatValue(new Double(getDiscountValue()));
    }


     public String printRefTotal() {

        return Formats.CURRENCY.formatValue(new Double(getTotal()+getCancelFee()));
    }

      public String printCancelFee() {

        return Formats.CURRENCY.formatValue(new Double(getCancelFee()));
    }
