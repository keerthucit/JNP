...
public class ProductInfoExt {
    ...
    protected String ticketGroup;
    protected int noofpeople;
    protected String ticketDiscount;
 ...
 public final String getTicketGroup() {
    ...
    public final void setTicketGroup(String value) {
        ticketGroup = value;
    }
     public final String getTicketDiscount() {
        return ticketDiscount;
    }
    public final void setTicketDiscount(String value) {
    ...
    public final void setNoofpeople(int value) {
        noofpeople = value;
    }
    ...
    public static SerializerRead getSerializerRead() {
        return new SerializerRead() { public Object readValues(DataRead dr) throws BasicException {
            ...
            product.minAmount = dr.getDouble(14).doubleValue();
            product.ticketGroup = dr.getString(15);
            product.noofpeople = dr.getInt(16);
            product.ticketDiscount = dr.getString(17);
            return product;
        }};
    }
