...
*/
    ...
    private void initComponents() {
        ...
        jLabel4.setText(AppLocal.getIntString("Menu.TicketCategory")); // NOI18N
        jPanel2.add(jLabel4);
        jLabel4.setBounds(10, 20, 90, 14);
        jPanel2.add(m_jName);
        m_jName.setBounds(120, 20, 240, 25);
        jPanel2.add(m_jUnits);
        m_jUnits.setBounds(120, 50, 240, 25);

        jPanel5.add(jPanel2, java.awt.BorderLayout.CENTER);

        jPanel1.setPreferredSize(new java.awt.Dimension(185, 90));
