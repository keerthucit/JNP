...
public class Place implements SerializableRead, java.io.Serializable {
    ...
    private  Icon ICO_FRE =new javax.swing.ImageIcon(getClass().getResource("/com/openbravo/images/seat.png"));
    ...
    public void readValues(DataRead dr) throws BasicException {
        ...
        m_btn.setBackground(Color.white);
    ...
    m_btn.setIcon(bValue ? ICO_OCU : ICO_FRE); 
         m_btn.setToolTipText(getName());
    }     
    public void setButtonBounds() {
     Dimension d = m_btn.getPreferredSize();
        //m_btn.setBounds(m_ix - d.width / 2, m_iy - d.height / 2, 28, 28); 
      m_btn.setBounds(m_ix - d.width / 2, m_iy - d.height / 2, 38, 38); 
    }
}    
