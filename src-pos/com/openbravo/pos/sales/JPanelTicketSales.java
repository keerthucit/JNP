...
public class JPanelTicketSales extends JPanelTicket {
   ...
   //super.setAdvanceShowName("");
        super.advanceShowName="";
        super.closeButton();
        super.activate();
        m_cat.loadCatalog();
    }

     public void activate(String showname) throws BasicException {
        super.activate();
         m_cat.loadCatalog(showname);
    }
