...
INSERT INTO ROLES(ID, NAME, PERMISSIONS) VALUES('1', 'Ticket Counter', $FILE{/com/openbravo/pos/templates/Role.Cashier.xml} );
INSERT INTO ROLES(ID, NAME, PERMISSIONS) VALUES('2', 'Extended Counter', $FILE{/com/openbravo/pos/templates/Role.Extcounter.xml} );
INSERT INTO ROLES(ID, NAME, PERMISSIONS) VALUES('3', 'System Admin', $FILE{/com/openbravo/pos/templates/Role.Sysadmin.xml} );
...
INSERT INTO PEOPLE(ID, NAME, USERNAME, APPPASSWORD, ROLE, VISIBLE, IMAGE) VALUES ('0', 'Administrator','admin', 'admin', '0', TRUE, NULL);
INSERT INTO PEOPLE(ID, NAME, USERNAME, APPPASSWORD, ROLE, VISIBLE, IMAGE) VALUES ('1', 'Ticket Counter','counter', 'counter', '1', TRUE, NULL);
INSERT INTO PEOPLE(ID, NAME, USERNAME, APPPASSWORD, ROLE, VISIBLE, IMAGE) VALUES ('2', 'Extended Counter','extcounter', 'extcounter', '2', TRUE, NULL);
INSERT INTO PEOPLE(ID, NAME, USERNAME, APPPASSWORD, ROLE, VISIBLE, IMAGE) VALUES ('3', 'System Admin','sysadmin', 'sysadmin', '3', TRUE, NULL);
...
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('31', 'Printer.CloseShow', 0, $FILE{/com/openbravo/pos/templates/Printer.CloseShow.xml});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('32', 'Code.ReceiptConsolidate', 0, $FILE{/com/openbravo/pos/templates/code.ReceiptConsolidate.txt});
...
CREATE TABLE PRODUCTS (
    ...
    TICKETGROUP VARCHAR(1) DEFAULT 'N',
    MINAMOUNT DOUBLE,
    NOOFPEOPLE INTEGER,
    ACTIVE VARCHAR(1) NOT NULL DEFAULT 'Y',
    TICKETDISCOUNT VARCHAR(1) DEFAULT 'N',
    PRIMARY KEY (ID),
...
CREATE INDEX CLOSEDSHOW_INX_1 ON CLOSEDSHOW(DATESTART);
CREATE INDEX CLOSEDSHOW_INX_SEQ ON CLOSEDSHOW(HOST, HOSTSEQUENCE);
...
CREATE TABLE RECEIPTS (
    ...
    MONEY VARCHAR(255) NOT NULL,
    DATENEW DATETIME NOT NULL,
    MONEYSHOW VARCHAR(255) NOT NULL,
    ATTRIBUTES MEDIUMBLOB,
    ADVANCEBOOKING VARCHAR(1) DEFAULT 'N',
    ADVANCEDATE VARCHAR(20),
    PRIMARY KEY(ID),
    CONSTRAINT RECEIPTS_FK_MONEY FOREIGN KEY (MONEY) REFERENCES CLOSEDCASH(MONEY),
    CONSTRAINT RECEIPTS_FK_MONEYSHOW FOREIGN KEY (MONEYSHOW) REFERENCES CLOSEDSHOW(MONEY)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE TICKETS (
    ...
    CANCELLATIONFEE DOUBLE DEFAULT 0 NOT NULL,
...
CREATE TABLE HOLIDAYINTERMEDIATE (
  ID VARCHAR(255) NOT NULL,
  WEEK VARCHAR(5),
  DAY VARCHAR(10),
  YEAR INTEGER(10),
...
CREATE TABLE HOLIDAYLIST (
  ...
  GENERAL VARCHAR(1) NOT NULL DEFAULT 'Y',
  YEAR INTEGER(6) NOT NULL,
  HOLIDAYID VARCHAR(255) DEFAULT NULL,
  PRIMARY KEY (ID),
 CONSTRAINT HOLIDAY_FK_1 FOREIGN KEY (HOLIDAYID) REFERENCES HOLIDAYINTERMEDIATE (ID)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE EXTENDEDSEATS (
  ID VARCHAR(255) NOT NULL,
  SHOWNAME VARCHAR(255) NOT NULL,
  DATE DATETIME NOT NULL,
  NOOFSEATS INTEGER(10) NOT NULL,
...
CREATE TABLE SHOWS (
  ...
  NOOFSEATS INTEGER(6) NOT NULL,
  SPECIAL VARCHAR(1) DEFAULT 'N',
  SHOWTYPE VARCHAR(20),
  SPECIALSHOWDATE DATETIME default NULL,
...
CREATE TABLE CANCELLATION (
  ID VARCHAR(255) NOT NULL,
  CANCELLATIONFEE DOUBLE(6,1) NOT NULL,
  TIMELIMIT INT(6) NOT NULL,
  CREATED DATETIME NOT NULL,
  CREATEDBY VARCHAR(255) NOT NULL,
  ACTIVE VARCHAR(1) NOT NULL DEFAULT 'Y',
  PRIMARY KEY  (ID)
...
CREATE TABLE DISCOUNTSETUP (
  ID VARCHAR(255) NOT NULL,
  DISCOUNTAMOUNT DOUBLE(6,1) NOT NULL,
